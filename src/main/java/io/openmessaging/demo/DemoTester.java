...
public class DemoTester {
    ...
    public static void main(String[] args) {
        ...
        //�����������
        String topic1 = "TOPIC_1"; //ʵ�ʲ���ʱ��Ż���100��Topic����
        String topic2 = "TOPIC_2"; //ʵ�ʲ���ʱ��Ż���100��Topic����
        String queue1 = "QUEUE_1"; //ʵ�ʲ���ʱ��Ż���100��Queue����
        String queue2 = "QUEUE_2"; //ʵ�ʲ���ʱ��Ż���100��Queue����
...
//continue;
                ...
                //Assert.assertEquals(messagesForQueue2.get(q  ueue2Offset++), message);
